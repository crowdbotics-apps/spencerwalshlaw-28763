...
## Project Structure
    ...
    ├── spencerwalshlaw_28763  # Django project configurations
...
1. Clone this repo and `cd spencerwalshlaw_28763`
...
2. Clone this repo and `cd spencerwalshlaw_28763`
